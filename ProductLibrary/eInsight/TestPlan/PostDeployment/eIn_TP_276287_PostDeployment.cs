...
namespace eInsightPostDeployment
{
    class eIn_TP_276287_PostDeployment : eInsightSetup
    {
        public static string GetProjectName = System.Reflection.Assembly.GetCallingAssembly().GetName().Name;

        public eIn_TP_276287_PostDeployment(string browser, string version, string os, string resolution) : base(browser, version, os, resolution)
        {
            Drivers = new ThreadLocal<IWebDriver>();
        }
        public eIn_TP_276287_PostDeployment()
        { }
        [SetUp]

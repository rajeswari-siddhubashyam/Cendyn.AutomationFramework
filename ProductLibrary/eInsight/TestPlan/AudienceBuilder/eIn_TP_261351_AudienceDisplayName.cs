...
namespace eInsightAudienceBuilderDisplayName
{
    class eIn_TP_261351_AudienceDisplayName : eInsightSetup
    {
        public static string GetProjectName = System.Reflection.Assembly.GetCallingAssembly().GetName().Name;
        public eIn_TP_261351_AudienceDisplayName()
        { }

        public eIn_TP_261351_AudienceDisplayName(string browser, string version, string os, string resolution) : base(browser, version, os, resolution)
        {
        ...
        public static void Initialize()
        {
            ...
            TestPlanId = Constants.TP_261351;
        ...
        public static void TC_261391()
        {
            try
            {
                ...
                Legacy_SetupTestCase(Constants.TC_261391);
        ...
        public static void TC_261396()
        {
            ...
            {
                /**Test execution - Start**/
                Legacy_SetupTestCase(Constants.TC_261396);

...
namespace CMS.Utility
{
    public class Setup : BaseUtility.Utility.Setup
    {
        ...
        public static void InitializeSetup(string testPlanId, Enum clientName, Enum testDataType, Enum caseType, string projectName = null)
        {
            ...
            Setup.build = Environment.GetEnvironmentVariable("LT_BUILD") == null ? "CMS_LambdaTestExecution_" + DateTime.Now.ToString("MM") + DateTime.Now.ToString("dd") + DateTime.Now.ToString("yyyy") : Environment.GetEnvironmentVariable("LT_BUILD");
            //Initialize the test case set up.
            SetupTestPlan(eProduct.CMS, clientName, testDataType, caseType, projectName);

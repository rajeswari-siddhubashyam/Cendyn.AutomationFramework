...
namespace CHC_Config.Utility
{
    class ObjectRepository
    {
        ...
        #region[CreateUser]
        public static string Userdashboard_Filter_Enter_value { get; set; }
        public static string Userdashboard_Filter_Apply_Button { get; set; }
        ...
        public static string User_Dashboard_Properties_tab { get; set; }
        ...
        public static string UserDashboard_EditUser_Button { get; set; }
        public static string UserDashboard_Proeprty_tab_PropertyId_filter { get; set; }
        public static string UserDashboard_Proeprty_tab_PropertyName_filter { get; set; }
        public static string UserDashboard_Chain_tab_ChainId_filter { get; set; }
        public static string UserDashboard_Chain_tab_ChainName_filter { get; set; }
        public static string UserDashboard_Brand_tab_BrandId_filter { get; set; }
        public static string UserDashboard_Brand_tab_BrandName_filter{ get; set; }
        public static string Config_Organization { get; set; }
        ...
        public static ObjectRepository ReadElement(string location, string nodeModule)
        {
            ...
            foreach (KeyValuePair<string, string> pair in query)
            {
                ...
                {
                    if (pair.Key == "User_Dashboard_Properties_tab")
                            User_Dashboard_Properties_tab = pair.Value;
                    else if (pair.Key == "Userdashboard_Filter_Enter_value")
                        Userdashboard_Filter_Enter_value = pair.Value;
                    else if (pair.Key == "Userdashboard_Filter_Apply_Button")
                        Userdashboard_Filter_Apply_Button = pair.Value;
                    else if (pair.Key == "User_Tab_Leftnav")
                        ...
                        else if (pair.Key == "UserDashboard_EditUser_Button")
                            UserDashboard_EditUser_Button = pair.Value;
                        else if (pair.Key == "UserDashboard_Proeprty_tab_PropertyId_filter")
                            UserDashboard_Proeprty_tab_PropertyId_filter = pair.Value;
                        else if (pair.Key == "UserDashboard_Proeprty_tab_PropertyName_filter")
                            UserDashboard_Proeprty_tab_PropertyName_filter = pair.Value;
                        else if (pair.Key == "UserDashboard_Chain_tab_ChainId_filter")
                            UserDashboard_Chain_tab_ChainId_filter = pair.Value;
                        else if (pair.Key == "UserDashboard_Chain_tab_ChainName_filter")
                            UserDashboard_Chain_tab_ChainName_filter = pair.Value;
                        else if (pair.Key == "UserDashboard_Brand_tab_BrandId_filter")
                            UserDashboard_Brand_tab_BrandId_filter = pair.Value;
                        else if (pair.Key == "UserDashboard_Brand_tab_BrandName_filter")
                            UserDashboard_Brand_tab_BrandName_filter = pair.Value;
                    }
                #endregion[CreateUser]               
            }
            return obj;

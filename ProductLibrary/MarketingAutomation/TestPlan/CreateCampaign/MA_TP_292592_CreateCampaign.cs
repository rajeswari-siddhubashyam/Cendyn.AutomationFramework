...
namespace MarketingAutomation.TestPlan.ClientName
{
    class MA_TP_292592_CreateCampaign : MarketingAutomation.Utility.Setup
    {
        ...
        public static void Initialize()
        {
            ...
            InitializeSetup(Constants.TP_292592, Constants.clientEnv.MarketingAuto, Enums.TestDataType.Controller, Enums.CaseType.NA, "MarketingAuto");
        ...
        public static void TC_292525()
        {
            try
            {
                ...
                SetupTestCase(Constants.TC_292525, "Excel", MarketingAutomation.Utility.Constants.clientEnv.MarketingAuto, Enums.TestDataType.FrontEnd, Enums.CaseType.TestCase);

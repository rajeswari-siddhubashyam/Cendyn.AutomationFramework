...
namespace MarketingAutomation.AppModule.MainAdminApp
{
    public partial class MainAdminApp : Utility.Setup
    {
        ...
        {
            if (TestCaseId == Constants.TC_330363)
            {
                ...
                Logger.WriteDebugMessage("User should land on Manage Template page.");
                ...
                //Step4: Click on Campaign Tab > Summary.
        ...
        {
            if (TestCaseId == Constants.TC_330364)
            {
                //Variables declaration and object creation
                string filterOption;
                ...
                //Step5: Click on Name column > Icon 
                ManageTemplate.ClickOnFilterIconAndVerifyFilterOptionsDropDownValue("Name", filterOption);
                Logger.WriteDebugMessage("Expected Result:- It should display Campaign Name. Search By Tab " +
                                         "should get open with option as below:- Start With. End With. Contains. Equals.");
        ...
        {
            if (TestCaseId == Constants.TC_330365)
            {
                ...
                //Step5: Click on Status column > Icon 
                ManageTemplate.ClickOnFilterIconAndVerifyFilterOptionsDropDownValue("Status", filterOption);
                Logger.WriteDebugMessage("Expected Result:-It should display status of campaign It can be search by look up selection"+
        ...
        {
            if (TestCaseId == Constants.TC_330366)
            {
                ...
                Logger.WriteDebugMessage("Expected Result:- It should display date of last updated Search by Date should get open with option as below:-"+
                                            " Equals Date Between Date");
                PageObject_ManageTemplate.Filter_Text().Click();
                CreateCampaign.Campaign_Click_Clear();
